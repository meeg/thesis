...
Wide-angle bremsstrahlung is the other important source of $e^+e^-$ pairs.
...
As in Figure \ref{fig:vertex_data-mc}, comparisons of the background distribution in Monte Carlo and data show that the Monte Carlo accurately simulates the processes that create the tails and the tails found in Monte Carlo are good fits to the data.
...
Since the background distributions are steep
...
This is shown in Figure \ref{fig:upper_limit}, which shows that this analysis, on this data, is a factor of 106 from excluding any portion of the parameter space.
